...
export default function Features() {
  return (
    <section className="bg-white text-neutral-900">
      ...
      {/* TOP FEATURES */}
      <div className="w-full max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-y-10 gap-x-2 py-12 px-4 sm:px-6 border-b border-black/10">
        ...
        {[
          ...
          <div key={index} className="flex flex-col items-center gap-3 text-neutral-600">

            {/* Icon circle */}
            <div className="w-11 h-11 flex items-center justify-center rounded-full border border-black/10 bg-white text-yellow-600">
              {item.icon}
            </div>
      ...
      {/* STATS (UPDATED) */}
      <div className="bg-gradient-to-r from-neutral-50 via-neutral-50 to-neutral-100 py-20">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 text-center gap-12 px-6">
          ...
          <div>
            ...
            <p className="text-neutral-600 text-xs tracking-[0.2em] leading-relaxed">
